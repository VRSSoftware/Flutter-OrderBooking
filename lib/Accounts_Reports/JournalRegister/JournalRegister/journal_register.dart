...
class JournalRegisterPage extends StatefulWidget {
  const JournalRegisterPage({super.key});

  @override
  State<JournalRegisterPage> createState() => _JournalRegisterPageState();
}

class _JournalRegisterPageState extends State<JournalRegisterPage> {
  ...
  Future<void> _viewReport() async {
    ...
    try {
      ...
      final pdfBytes = await AccountReportService.generateJournalRegisterReport(
      ...
      if (pdfBytes != null && mounted) {
        final path = await AccountReportService.savePdfToTemp(
          pdfBytes,
          'JournalRegister_${DateTime.now().millisecondsSinceEpoch}.pdf',
        );
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) => CommonFilterPage(
                        title: 'Journal Register Filters',
                        reportType: 'JournalRegister',
