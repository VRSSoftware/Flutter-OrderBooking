...
class CreditNoteRegisterPage extends StatefulWidget {
  const CreditNoteRegisterPage({super.key});

  @override
  State<CreditNoteRegisterPage> createState() => _CreditNoteRegisterPageState();
}

class _CreditNoteRegisterPageState extends State<CreditNoteRegisterPage> {
  ...
  Future<void> _viewReport() async {
    ...
    try {
      ...
      final pdfBytes = await AccountReportService.generateCreditNoteRegisterReport(
      ...
      if (pdfBytes != null && mounted) {
        final path = await AccountReportService.savePdfToTemp(
          pdfBytes,
          'CreditNoteRegister_${DateTime.now().millisecondsSinceEpoch}.pdf',
        );
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) => CommonFilterPage(
                        title: 'Credit Note Register Filters',
                        reportType: 'CreditNoteRegister',
