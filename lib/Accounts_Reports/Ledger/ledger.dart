...
//   // Selected Filters
//   String selectedLedgerType = 'all'; // 'all', 'customer', 'vendor'
...
//     int count = 0;
//     if (selectedLedgerType != 'all') count++;
...
//       debugPrint('Selected State IDs: $stateIds');
//       debugPrint('Selected City IDs: $cityIds');
//       debugPrint('Selected Group IDs: $groupIds');
//       debugPrint('Selected SubGroup IDs: $subGroupIds');
//       debugPrint('Ledger Type: $selectedLedgerType');
...
//                         onLedgerTypeChanged: (v) => setState(() => selectedLedgerType = v ?? 'all'),
//                         onStatesChanged: (v) => setState(() => selectedStates = v ?? []),
//                         onCitiesChanged: (v) => setState(() => selectedCities = v ?? []),
