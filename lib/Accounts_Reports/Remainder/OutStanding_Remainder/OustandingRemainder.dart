...
class OutstandingRemainderPage extends StatefulWidget {
  const OutstandingRemainderPage({super.key});

  @override
  State<OutstandingRemainderPage> createState() => _OutstandingRemainderPageState();
}

class _OutstandingRemainderPageState extends State<OutstandingRemainderPage> {
  ...
  Future<void> _fetchDropdownData() async {
    await Future.wait([
      fetchStates(),
      fetchCities(),
      fetchOutstandingRemainderLedgers(),
    ]);
  }
  ...
  Future<void> fetchOutstandingRemainderLedgers() async {
    setState(() => _isLoadingLedgers = true);
    try {
      final fetchedLedgers = await AccountReportService.fetchOutstandingRemainderLedgers();
      if (mounted) {
        setState(() {
  ...
  String _getSubtitle() {
    ...
    if (filters.isEmpty) {
      return 'All Outstanding Remainders';
    }
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => CommonFilterPage(
                        title: 'Outstanding Remainder Filters',
                        reportType: 'OutstandingRemainder',
                        states: states,
                        cities: cities,
                        ledgers: ledgers,
