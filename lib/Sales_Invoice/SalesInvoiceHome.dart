...
class SaleInvoiceHome extends StatefulWidget {
  @override
  _SaleInvoiceHomeState createState() => _SaleInvoiceHomeState();
}

class _SaleInvoiceHomeState extends State<SaleInvoiceHome>
  ...
  IconStyle _getIconStyle(String label) {
    switch (label) {
      case 'Sales Invoice With Packing':
        return IconStyle(
          Icons.receipt_long,
          Colors.blue[700]!,
          Colors.blue[50]!,
  ...
  Widget _buildOptionsGrid(BuildContext context, double screenWidth) {
    ...
    List<Map<String, dynamic>> options = [
      {
        "label": "Sales Invoice With Packing",
        "route": "/SaleInvoiceWithPOPage",
        "icon": Icons.receipt_long,
        "color": Colors.blue,
        "description":
            "Create Sale Invoice against Packing Orders with order references",
      },
      {
        "label": "Sales Invoice ",
        "route": "/SaleInvoiceWithoutPOPage",
        "icon": Icons.receipt,
        "color": Colors.purple,
        "description":
            "Create Sales Invoice without PO references",
      },
    ];
