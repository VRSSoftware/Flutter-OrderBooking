    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            // Item Name and Brand
                            // Find this section in _buildOrderItem (around line 900-950)
                            // Look for the Wrap widget inside the Container after the Divider
          ...
          // Table for each shade - FULL WIDTH
          ...selectedColors.map(
            (shade) => Column(
              children: [
