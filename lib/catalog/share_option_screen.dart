...
//   })
//   onPDFShare;
//   final Function(bool, bool, bool, bool, bool, bool, bool, bool, bool)
//   onToggleOptions;
...
class ShareOptionsPage extends StatefulWidget {
  final Function({
    ...
    bool includeProduct,
    bool includeRemark,
    bool shadeWiseImage,  // New parameter for shade wise image option
  })
  onImageShare;
  final Function({
    bool includeDesign,
  ...
  onPDFShare;
  final Function(bool, bool, bool, bool, bool, bool, bool, bool, bool, bool)  // Added bool for shadeWiseImage
  onToggleOptions;
  final bool includeDesign;
  final bool includeShade;
  final bool includeRate;
  ...
  final bool includeProduct;
  final bool includeRemark;
  final bool shadeWiseImage;  // New property for initial state
  final VoidCallback onLinkShare;
  ...
  const ShareOptionsPage({
    ...
    required this.includeProduct,
    required this.includeRemark,
    required this.shadeWiseImage,  // Required parameter
    required this.onLinkShare,
  }) : super(key: key);
...
class _ShareOptionsPageState extends State<ShareOptionsPage> {
  ...
  late bool includeProduct;
  late bool includeRemark;
  late bool shadeWiseImage;  // New state variable
  ...
  void initState() {
    ...
    includeProduct = widget.includeProduct;
    includeRemark = widget.includeRemark;
    shadeWiseImage = widget.shadeWiseImage;  // Initialize new state
  }
  ...
  Future<void> _showToggleOptions(BuildContext context) async {
    ...
    if (options != null) {
      ...
      widget.onToggleOptions(
        ...
        includeProduct,
        includeRemark,
        shadeWiseImage,  // Pass the current shadeWiseImage value
      );
    }
  }
   ...
   child: Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Shade Wise Image option with checkbox (5th option)
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  // subtitle: shadeWiseImage 
                  //     ? const Text('Will Share All Shade Images')
                  //     : const Text('Will Share Only Main Image'),
                  trailing: Checkbox(
                    value: shadeWiseImage,
                    onChanged: (bool? value) {
                      setState(() {
                        shadeWiseImage = value ?? false;
                      });
                    },
