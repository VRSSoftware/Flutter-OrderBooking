...
class PackingListHome extends StatefulWidget {
  @override
  _PackingListHomeState createState() => _PackingListHomeState();
}

class _PackingListHomeState extends State<PackingListHome>
  ...
  IconStyle _getIconStyle(String label) {
    switch (label) {
      case 'Packing List with SO':
        return IconStyle(
          Icons.receipt_long,
          Colors.blue[700]!,
          Colors.blue[50]!,
        );
      case 'Packing List without SO':
        return IconStyle(
          Icons.receipt,
          Colors.purple[700]!,
          Colors.purple[50]!,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Create and manage packing lists for orders',
                  style: GoogleFonts.poppins(
                    fontSize: 11,
  ...
  Widget _buildOptionsGrid(BuildContext context, double screenWidth) {
    ...
    // List of packing list options with correct subtitles
    List<Map<String, dynamic>> options = [
      {
        "label": "Packing List with SO",
        "route": "/packingListWithSO",
        "icon": Icons.receipt_long,
        "color": Colors.blue,
        "description":
            "Create packing lists against Sales Orders with order references",
      },
      {
        "label": "Packing List without SO",
        "route": "/packingListWithOutSO",
        "icon": Icons.receipt,
        "color": Colors.purple,
        "description":
            "Create standalone packing lists without Sales Order references",
      },
    ];
