                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                hasVarPerc
                                    ? 'Select Quantity (Max: ${totalAllowedQty.toStringAsFixed(0)} $unitName)'
                                    : 'Select Quantity (Max: ${stkQty.toStringAsFixed(0)} $unitName available)',
                                style: TextStyle(
                                  fontSize: 11,
                                  fontWeight: FontWeight.w500,
                                  color: Colors.grey.shade700,
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Text(
                                            '₹${(selectedQty * rate).toStringAsFixed(2)}',
                                            style: TextStyle(
                                              fontSize: 11,
                                              fontWeight: FontWeight.bold,
                                              color: Colors.green.shade700,
                              ...
                              if (selectedQty > (hasVarPerc ? totalAllowedQty : stkQty))
                                Padding(
                              ...
                              if (hasVarPerc)
                                Padding(
                                  padding: const EdgeInsets.only(top: 4),
                                  child: Text(
                                    'Note: You can select up to $totalAllowedQty (Balance Qty $balQty + Var Qty $varQty)',
                                    style: TextStyle(
                                      fontSize: 9,
                                      color: Colors.grey.shade600,
                              ...
                              if (!hasVarPerc && stkQty > 0)
                                Padding(
                                  padding: const EdgeInsets.only(top: 4),
                                  child: Text(
                                    'Note: Only stock validation applies. Available stock: ${stkQty.toStringAsFixed(0)} $unitName',
                                    style: TextStyle(
                                      fontSize: 9,
                                      color: Colors.grey.shade600,
                                      fontStyle: FontStyle.italic,
