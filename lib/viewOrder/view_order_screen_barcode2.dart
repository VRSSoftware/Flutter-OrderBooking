...
//                       orderNo: orderNumber, // Use orderNumber directly
//                       orderData: null,
...
//   // If item contains --> then search only name part
//   final namePart = item.contains('-->')
//       ? item.split('-->').first.trim().toLowerCase()
//       : item.toLowerCase();
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) => OrderReportViewPage(
                                orderNo:
                                    orderNumber, // Use orderNumber directly
                                orderData: null,
                                showOnlyWithImage: false,
                              ),
                        ),
...
class _StyleCardState extends State<StyleCard> {
  ...
  Widget buildOrderItem(CatalogOrderData catalogOrder, BuildContext context) {
    ...
    return Card(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Header Section with Image and Style Info (with padding)
          Padding(
            padding: const EdgeInsets.all(
              12,
            ), // Added padding only for header section
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                // Style Code and Item Name in "stylecode --> itemname" format
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // Style Code with Badge and Item Name - with gradient background
                      Container(
                        padding: const EdgeInsets.symmetric(
                          horizontal: 12,
                          vertical: 8,
          ...
          // Stock Type, Stock Qty, Order Qty, Order Amount in Horizontal Row (with padding)
          Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _buildStatItem(
                    icon:
                        catalog.upcoming_Stk == '1'
                            ...
                            : Icons.check_circle,
                    label: 'Stock Type',
                    value: catalog.upcoming_Stk == '1' ? 'Upcoming' : 'Ready',
                    color:
                        catalog.upcoming_Stk == '1'
                            ? Colors.orange
                            : Colors.green,
                  ...
                  _buildStatItem(
                    ...
                    label: 'Stock Qty',
                    value: _calculateStockQuantity().toString(),
                    color: Colors.blue,
                  ),
                  ...
                  _buildStatItem(
                    ...
                    label: 'Order Qty',
                    value: _calculateCatalogQuantity().toString(),
                    color: Colors.orange,
                  ),
                  ...
                  _buildStatItem(
                    ...
                    label: 'Order Amt',
                    value: '₹${_calculateCatalogPrice().toStringAsFixed(0)}',
                    color: Colors.green,
                  ),
                ],
              ),
          ...
          // Color Sections (Original table preserved exactly - now full width with no padding)
          ...widget.selectedColors.map(
            (color) => Column(
              children: [
                // Original color section table (now full width with no padding)
                _buildColorSection(widget.catalogOrder, color),
  ...
  // Helper method for stat items in horizontal row
      ...
      child: Column(
        ...
        children: [
          Container(
            width:
                double
                    .infinity, // This ensures the table container takes full width
            decoration: BoxDecoration(
              border: Border.all(color: Colors.grey.shade300),
            ),
            child: Column(
  ...
  Widget _buildSizeRow(
    ...
    if (shadeIndex != -1 && sizeIndex != -1) {
      ...
      stock = matrixData[2] ?? '0';
      controller =
          widget.styleManager.controllers[widget.styleCode]?[shade]?[size];
    }
