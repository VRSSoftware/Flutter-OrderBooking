...
class OutstandingPayablePage extends StatefulWidget {
  ...
  @override
  State<OutstandingPayablePage> createState() =>
      _OutstandingPayablePageState();
}
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Container(width: 14, height: 14, decoration: BoxDecoration(color: Colors.orange, borderRadius: BorderRadius.circular(2))),
                    const SizedBox(width: 6),
                    Text("Payable Amount", style: GoogleFonts.poppins(fontSize: 10, color: AppColors.slate600)),
